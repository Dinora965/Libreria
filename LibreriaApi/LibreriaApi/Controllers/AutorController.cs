...
namespace LibreriaApi.Controllers
{
    public class AutorController : ApiController
    {
        ...
        /// GET: api/Autor
        /// <summary>
        /// Obtiene la lista de todos los autores registrados en la base de datos.
        /// </summary>
        ...
        /// GET: api/Autor/5
        /// <summary>
        /// Obtiene los detalles de un autor específico mediante su ID.
        /// </summary>
        /// <param name="id"></param>
        /// <returns>JSON Autor</returns>
        ...
        /// PUT: api/Autor/5
        /// <summary>
        /// Actualiza los detalles de un autor existente en la base de datos.
        /// </summary>
        ...
        /// DELETE: api/Autor/5
        /// <summary>
        /// Elimina un autor específico de la base de datos mediante su ID.
        /// </summary>
        /// <param name="id"></param>
        /// <returns>JSON Autor</returns>
