    ...
    public class Empleado_planillaController : ApiController
    {
        ...
        public IHttpActionResult Get()
        {
            var query = from empleado1 in db.Empleados
                        ...
                        select new
                        {
                            IdLibro = empleado_planilla.Id,
                            IdAutor = empleado1.Nombre,
                            TituloLibro = empleado_planilla.Anticipo,
                            Ideditorial = bonificaciones1.Monto,
                            Aniodepublicacion = deducciones1.Monto,
                            cantidad = empleado_planilla.Sueldoneto
        ...
        public IHttpActionResult Post(Empleado_planilla empleado_planilla, int idempleado, int idbonificacion, int iddeduccion)
        {
            ...
            empleado_planilla.Sueldoneto = (empleado_planilla.Anticipo + bonificacionexistente.Monto + empleadoexistente.Salario - deduccionexistente.Monto);
